...
|------------|--------|-----------------------------------------|-----------------------------------|------------|
| WADIQAM-FR | FR     | 高精度，对抗性攻击鲁棒性强              | 视频编码、专业图像处理            | ★★★★☆      |
| CLIPIQA    | NR     | 支持抽象感知评估，适配AI生成图像        | GAN质量控制、艺术创作            | ★★★★☆      |
| MANIQA     | NR     | 针对生成失真优化，检测准确率高          | GAN生成图像、超分辨率            | ★★★★★      |
| PI         | NR     | 结合空域/时域特征，贴近美学感知        | 自然图像筛选、社交媒体内容审核    | ★★★☆☆      |
| DISIS      | 主观   | 黄金标准，校准客观指标                | 标准制定、复杂失真评估            | ★★★★★      |
